...
LABEL org.opencontainers.image.title="MediBill - Medical Billing System" \
      org.opencontainers.image.description="Spring Boot pharmacy billing with JWT security, inventory alerts (low stock, near expiry, expired), navbar notifications, dashboard master links (customers, suppliers), SMS/email, and dashboard" \
